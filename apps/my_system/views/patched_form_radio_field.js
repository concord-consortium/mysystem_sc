...
// ==========================================================================
/*globals Forms, MySystem */

/** @class
  A FormFieldView specialization for RadioViews.
  @extends SC.FormFieldView
*/
require("views/improved_radio");
MySystem.PatchedFormRadioView = Forms.FormFieldView.extend(
    ...
    this.fieldClass = this.fieldClass.extend({
      ...
      measure: function()
      {
        if (this.get("autoResize"))
        {
          ...
          var targetWidth = layer.scrollWidth + 14;  // TODO: Fix this
