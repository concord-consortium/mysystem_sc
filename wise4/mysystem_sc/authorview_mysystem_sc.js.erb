/*globals View createElement createBreak eventManager */
/**
 * Sets the TemplateNode type as an object of this view
 */
View.prototype.Mysystem_scNode = {};
 ...
 */
View.prototype.Mysystem_scNode.commonComponents = [];
 ...
 */
View.prototype.Mysystem_scNode.generatePage = function(view){
  this.view = view;
 ...
 */
View.prototype.Mysystem_scNode.getCommonComponents = function() {
 ...
 */
View.prototype.Mysystem_scNode.updateContent = function(){
 ...
 */
View.prototype.Mysystem_scNode.populatePrompt = function() {
 ...
 */
View.prototype.Mysystem_scNode.updatePrompt = function(){
  /* update content */
...
if (typeof eventManager !== 'undefined') {
  eventManager.fire('scriptLoaded', 'vle/node/mysystem_sc/authorview_mysystem_sc.js');
}